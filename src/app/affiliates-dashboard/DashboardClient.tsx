...
// Owner dashboard UI (client). Rendered only after the server component in
// page.tsx confirms the caller is an authenticated admin. Data comes from the
// admin-gated /api/whop/affiliates.
...
export default function AffiliatesDashboardClient() {
